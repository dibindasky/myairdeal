  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(
        () => RefreshIndicator(
          onRefresh: onRefresh,
          child: controller.retrieveAllCompletedBooking.isEmpty ||
                        ...
                        if (controller.bookingLoading.value) {
                          ...
                          if (controller.selectedBookingTab.value == 1) {
                            ...
                            return ListView.separated(
                              ...
                              itemCount:
                                  controller.retrieveAllCompletedBooking.length,
                              shrinkWrap: true,
                            ...
                            return ListView.separated(
                              ...
                              separatorBuilder: (context, index) => kHeight10,
                              itemCount:
                                  controller.retrieveAllCancelBooking.length,
                              shrinkWrap: true,
                              itemBuilder: (context, index) => GestureDetector(
                                onTap: () {
                                  controller.getSingleBooking(
                            ...
                            return ListView.separated(
                              ...
                              separatorBuilder: (context, index) => kHeight10,
                              itemCount:
                                  controller.retrieveAllUpcomingBooking.length,
                              shrinkWrap: true,
                              itemBuilder: (context, index) => GestureDetector(
                                onTap: () {
                                  controller.getSingleBooking(
