...
Tfr _$TfrFromJson(Map<String, dynamic> json) => Tfr(
      noShow: (json['NO_SHOW'] as List<dynamic>?)
          ?.map((e) => NoShow.fromJson(e as Map<String, dynamic>))
          .toList(),
      datechange: (json['DATECHANGE'] as List<dynamic>?)
          ?.map((e) => Datechange.fromJson(e as Map<String, dynamic>))
          .toList(),
      cancellation: (json['CANCELLATION'] as List<dynamic>?)
          ?.map((e) => Cancellation.fromJson(e as Map<String, dynamic>))
          .toList(),
      seatChargeable: (json['SEAT_CHARGEABLE'] as List<dynamic>?)
          ?.map((e) => SeatChargeable.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
